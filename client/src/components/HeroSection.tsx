    ...
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-20 overflow-hidden">
      ...
      <div className="max-w-[1920px] mx-auto px-10 relative z-10">
        <div className="flex flex-col items-center justify-center text-center">
          {/* Large 3D Icon */}
          <div className="mb-16" style={{ width: '520px', height: '595px' }}>
          ...
          {/* Company Name */}
          <div className="content-stretch flex font-['Poppins:Medium',_sans-serif] items-start leading-[1.2] not-italic text-nowrap text-white whitespace-pre mb-8">
            <h1 className="relative shrink-0 text-[180px] tracking-[-9px]">Power Plant Energy</h1>
            <p className="relative shrink-0 text-[40px] tracking-[-1.2px]">TM</p>
          </div>

          {/* Tagline */}
          <p className="font-['Poppins:Medium',_sans-serif] leading-[1.3] not-italic text-[42px] text-white/80 tracking-[-0.84px] max-w-[1000px]">
